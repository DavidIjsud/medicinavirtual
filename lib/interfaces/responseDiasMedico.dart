...
//
//     final responseDiasMedicos = responseDiasMedicosFromJson(jsonString);

import 'dart:convert';

ResponseDiasMedicos responseDiasMedicosFromJson(String str) => ResponseDiasMedicos.fromJson(json.decode(str));

String responseDiasMedicosToJson(ResponseDiasMedicos data) => json.encode(data.toJson());

class ResponseDiasMedicos {
    ResponseDiasMedicos({
        this.status,
        this.message,
        this.data,
    ...
    factory ResponseDiasMedicos.fromJson(Map<String, dynamic> json) => ResponseDiasMedicos(
        status: json["status"],
